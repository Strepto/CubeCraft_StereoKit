// Copied from https://github.com/dotnet-ad/Tween/blob/master/Sources/Tween/Ease.cs -- MIT License https://github.com/dotnet-ad/Tween/blob/master/LICENSE
// Extracted from https://bitbucket.org/jacobalbano/glide with refactoring

using System;
using JetBrains.Annotations;
// ReSharper disable CompareOfFloatsByEqualityOperator -- Its an optimization

namespace StereoKitApp.Utils.Easing
{
    /// <summary>
    /// Static class with useful easer functions that can be used by Tweens.
    /// </summary>
    [PublicAPI("Its a vendored file")]
    public static class Ease
    {
        private const float Pi = (float)Math.PI;
        private const float PiHalf = (float)Pi / 2;
        ...
        {
            return (float)(Math.Sin(13 * PiHalf * t) * Math.Pow(2, 10 * (t - 1)));
        }
        ...
        public static float ElasticOut(float t)
        {
            ...
            return (float)(Math.Sin(-13 * PiHalf * (t + 1)) * Math.Pow(2, -10 * t) + 1);
        }
        ...
        public static float ElasticInOut(float t)
        {
            ...
            {
                return (float)(
                    0.5 * Math.Sin(13 * PiHalf * (2 * t)) * Math.Pow(2, 10 * ((2 * t) - 1))
                );
            }

            return (float)(
                0.5
                * (Math.Sin(-13 * PiHalf * ((2 * t - 1) + 1)) * Math.Pow(2, -10 * (2 * t - 1)) + 2)
            );
        }
        ...
        /// <param name="t">Time elapsed.</param>
        /// <returns>Eased timescale.</returns>
        public static float CubeOut(float t) => (1 + (--t) * t * t);
        ...
        /// <param name="t">Time elapsed.</param>
        /// <returns>Eased timescale.</returns>
        public static float CubeInOut(float t) => (t <= .5 ? t * t * t * 4 : 1 + (--t) * t * t * 4);
        ...
        /// <param name="t">Time elapsed.</param>
        /// <returns>Eased timescale.</returns>
        public static float QuartOut(float t) => (1 - (t -= 1) * t * t * t);
        ...
        public static float QuartInOut(float t) =>
            (t <= .5f ? t * t * t * t * 8 : (1 - (t = t * 2 - 2) * t * t * t) / 2 + .5f);
        ...
        /// <param name="t">Time elapsed.</param>
        /// <returns>Eased timescale.</returns>
        public static float QuintOut(float t) => ((t = t - 1) * t * t * t * t + 1);
        ...
        /// <param name="t">Time elapsed.</param>
        /// <returns>Eased timescale.</returns>
        public static float SineIn(float t) => (t == 1) ? 1 : (float)(-Math.Cos(PiHalf * t) + 1);
        ...
        /// <param name="t">Time elapsed.</param>
        /// <returns>Eased timescale.</returns>
        public static float SineOut(float t) => (float)(Math.Sin(PiHalf * t));
        ...
        /// <param name="t">Time elapsed.</param>
        /// <returns>Eased timescale.</returns>
        public static float LinearIn(float t) => t;
        ...
        /// <param name="t">Time elapsed.</param>
        /// <returns>Eased timescale.</returns>
        public static float LinearOut(float t) => (1 - t);
    }
}
